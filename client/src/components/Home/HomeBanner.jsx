...
import BannerImg1 from '../../Ui_Images/home-banner-img1.jpg'
import BannerImg2 from '../../Ui_Images/home-banner-img2.jpg'

const HomeBanner = () => {

    return (
        <div className="home-banner-container">
            <div className="home-banner-up">
                <div className='home-banner-img1'>
                    <div className='home-banner-img1-image'>
                ...
                <div className='home-banner-img2'>
                    <div className='home-banner-img2-image'>
