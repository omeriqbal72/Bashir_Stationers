...
import AdminOrdersDivision from './components/Admin/AdminOrdersDivision.jsx';
                  ...
                  <Routes>
                    ...
                    <Route element={<PrivateRoute adminRoute={true} />}>
                      <Route element={<AdminLayout />}>
                        ...
                        <Route path="/admin/orders-division" element={<AdminOrdersDivision />} />
                        <Route path="/admin/orders-division/:orderId" element={<AdminOrdersDivision />} />
